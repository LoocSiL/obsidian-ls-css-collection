...
**Важно:** Для доступа к настройкам цветов убедитесь, что у вас установлен и включен плагин **Style Settings**. После включения сниппета в настройках Style Settings появится новый блок `💢 LS CSS File Explorer - Background Pills`.
